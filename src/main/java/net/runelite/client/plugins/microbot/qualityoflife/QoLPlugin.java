...
// import net.runelite.client.plugins.microbot.util.antiban.FieldUtil; // removed in 2.6.0
...
public class QoLPlugin extends Plugin implements KeyListener {
    ...
    private boolean updateUiElements() {
        try {
            ...
            // FieldUtil.setFinalStatic(accentColorField, config.accentColor()); // removed in 2.6.0
            ...
            // FieldUtil.setFinalStatic(onSwitcherPluginPanel, remapImage(SWITCHER_ON_IMG, config.toggleButtonColor())); // removed in 2.6.0
